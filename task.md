...
|----|---------|------|--------|------------|--------|------|
| T-001 | 音声入力モジュール実装 | SoundDeviceを使用したマイク音声キャプチャ | 開発者 | 未着手 | 高 | - |
| T-002 | PC内部音声モジュール実装 | SoundCardを使用したループバック録音 | 開発者 | 未着手 | 高 | - |
| T-003 | faster-whisper統合 | Whisper Large v2モデルのロードと推論 | 開発者 | 進行中 | 高 | - |
| T-004 | 音声区間検出実装 | Silero VADによる発話区間の検出 | 開発者 | 未着手 | 中 | - |
| T-005 | テキスト挿入機能実装 | pynputを使用したアクティブウィンドウへのテキスト挿入 | 開発者 | 未着手 | 高 | - |
| T-006 | グローバルショートカット実装 | Ctrl+Shift+Spaceによる録音開始/停止 | 開発者 | 未着手 | 高 | - |
| T-007 | リアルタイム処理パイプライン構築 | 音声キャプチャ→認識→挿入の統合処理 | 開発者 | 未着手 | 高 | - |
| T-008 | コア機能テスト | 基本的な音声認識とテキスト挿入の統合テスト | 開発者 | 未着手 | 高 | - |
...
| ID | タスク名 | 説明 | 担当者 | ステータス | 優先度 | 期限 |
|----|---------|------|--------|------------|--------|------|
| T-009 | SQLite3データベース設計 | ユーザー辞書と設定のデータベース設計 | 開発者 | 未着手 | 中 | - |
| T-010 | ユーザー辞書管理機能 | 専門用語・固有名詞の登録・編集・削除 | 開発者 | 未着手 | 中 | - |
| T-011 | 辞書マッチングアルゴリズム | 認識結果への辞書適用ロジック | 開発者 | 未着手 | 中 | - |
